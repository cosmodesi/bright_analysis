...
#
setup_keywords['name'] = 'bright_analysis'
setup_keywords['description'] = 'DESI bright-time analysis package'
setup_keywords['author'] = 'DESI Collaboration'
setup_keywords['author_email'] = 'a.p.cooper@durham.ac.uk'
setup_keywords['license'] = 'BSD'
setup_keywords['url'] = 'https://github.com/apcooper/bright_analysis'
#
